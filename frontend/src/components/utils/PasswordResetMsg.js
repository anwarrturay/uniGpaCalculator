...
const PasswordResetMsg = () => {
  return (
    <section>
        <div className="flex items-center gap-4 bg-[#00ff9570] rounded-sm w-[300px] xs:w-[312px] sm:w-[360px] p-2 mt-3">
            ...
            <div className="flex text-sm text-wrap">
                <div className="text-base text-green-800 font-medium">
                    ...
                    <Link to={'/'} className='ml-1 text-blue-500 font-medium gap-4'> Login here</Link>
                </div>
            </div>
        </div>
    </section>
