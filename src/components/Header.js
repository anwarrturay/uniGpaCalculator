  ...
  return (
    <div className='bg-[#F2F2F2] z-50 fixed top-0 left-0 right-0  h-[70px]'>
      <div className={`flex items-center ${mutableStyle} lg:${mutableStyle} lg:items-start lg:mt-3`}>
        ...
        {location.pathname === '/newcalculation' && 
          <Link to={'/studentdashboard'}>
            <div className='flex items-center'>
              ...
              <div className='font-medium text-[19px]'>Back</div>
            </div>
          </Link>
        }
        { width < 768 ?
            <div className="sm: w-[50px] ml-2">
        ...
        {location.pathname === '/studentdashboard' ? 
            <div className='font-[500] flex items-center justify-center text-xl text-center mr-3'>
              Student DashBoard
            </div>
          :
            <div className='font-[500] flex items-center justify-center text-xl mr-3 lg:text-2xl'>
              Add Modules
            </div>
        }
      </div>
